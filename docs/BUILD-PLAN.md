...
Be careful with wording in the README and video: what is generated at runtime is the
**preview, from the dispatch** — same rendering code, different dispatch, different
picture. Say "generated from the dispatch", never "generated by AI", and be ready to
prove it by changing the branch numbers on camera.
...
- State plainly that the approved plan is what would deploy to a physical robot
...
- Links out: repo, the 4:30 video, and the live supplier feed.
- ⚠️ Same wording discipline as slice 2: the rehearsal is **generated from the
  dispatch**, not "generated by AI". Do not let marketing voice blur that — the claim is
  falsifiable on camera by changing the branch numbers, so keep it exactly true.
